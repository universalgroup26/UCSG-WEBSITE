            ...
            {universities.map((uni, i) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full rounded-lg bg-gradient-to-r from-[#B31942] to-[#002868] px-3 py-2 text-xs font-bold text-white shadow-sm transition-all duration-200 hover:shadow-md hover:brightness-110 active:scale-95 sm:text-sm"
                >
