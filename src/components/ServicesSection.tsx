  ...
  return (
    <section ref={ref} className="bg-gradient-to-b from-white via-[#F8FAFC] to-white py-20 sm:py-28 lg:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-8 sm:mt-18 lg:mt-20">
          {/* Top Row: First 3 cards in a 3-col grid */}
          ...
          {/* Bottom Row: Last 2 cards - full width horizontal layout on desktop */}
          <div className="grid gap-8 lg:grid-cols-2">
            {services.slice(3).map((service, i) => {
              ...
              return (
                <motion.div
                  key={service.title}
                  className="group relative flex flex-col overflow-hidden rounded-2xl border border-gray-100/80 bg-white p-7 shadow-[0_2px_20px_-4px_rgba(0,40,104,0.08)] transition-all duration-300 hover:border-[#002868]/20 hover:shadow-[0_8px_30px_-4px_rgba(0,40,104,0.15)] sm:p-8 lg:flex-row lg:items-center lg:gap-8"
                  initial={{ opacity: 0, y: 30 }}
                  animate={isInView ? { opacity: 1, y: 0 } : {}}
                ...
                >
                  ...
                  <div className="mt-6 shrink-0 lg:mt-0">
                    <Button
                      variant="default"
                      onClick={() => onResourceClick?.(service.resourceId)}
                      className="group/btn relative overflow-hidden rounded-lg bg-gradient-to-r from-[#002868] to-[#001B4D] px-5 py-3 text-sm font-medium text-white transition-all duration-300 hover:brightness-110 hover:shadow-[0_4px_15px_rgba(0,40,104,0.3)]"
                    >
                      <span className="relative z-10">{service.cta}</span>
