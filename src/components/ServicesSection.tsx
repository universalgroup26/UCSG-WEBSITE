...
const services = [
  {
    ...
    description:
      "If your SEVIS is terminated or you need a university transfer, UCSG can connect you with SEVP-approved universities within 24\u201348 hours. Don't risk falling out of status \u2013 act now.",
  ...
  },
  {
    ...
    resourceId: 'day1-cpt',
    description:
      'Looking for universities that offer Day 1 CPT? UCSG works with reliable institutions across the USA that allow you to study and work legally from day one.',
  ...
  },
  {
    ...
    description:
      "Whether you're on B1/B2, F2, H1, H4, J1/J2 or another status, UCSG guides you through the Change of Status (COS) to F1 process. From I-20 issuance to university placement, we handle it all.",
  ...
  },
  {
    ...
    description:
      "A terminated SEVIS record doesn't have to end your journey. UCSG helps prepare strong reinstatement requests with supporting documentation to improve your chances of approval.",
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 sm:mt-16">
          {services.map((service) => {
            ...
            return (
              ...
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#E0F4F8]">
